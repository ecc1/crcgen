...
func main() {
	...
	switch kind {
	case "crc8":
		genCrc8(setup(kind), 0x9B) // WCDMA polynomial
	case "crc16":
		genCrc16(setup(kind), 0x1021) // CCITT polynomial
	default:
...
func setup(kind string) *os.File {
	...
	fmt.Fprintf(f, "// Generated by %s: do not edit\n\n", prog)
	fmt.Fprintf(f, "package %s\n\n", goPackage)
	return f
}

// Generate lookup table for CRC-8 calculation
func genCrc8(f *os.File, poly uint8) {
...
func genCrc16(f *os.File, poly uint16) {
